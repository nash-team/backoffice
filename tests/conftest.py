"""Integration test fixtures (requires Docker + testcontainers + cryptography)."""
...
# Guard heavy imports that require cryptography / authlib at import time.
# These are only needed when integration tests actually run.
try:
