...
class AuthService:
    def __init__(self, auth_port: AuthPort, user_repository: UserRepositoryPort) -> None:
    ...
    def register_user(self, user_create: UserCreate) -> User:
        ...
        user = User(
            email=user_create.email, username=user_create.username, hashed_password=hashed_password
        )
