...
class ProviderFactory:
    ...
    def create_cover_provider(
        ...
        """
        # Use fake provider for E2E tests (no cache for fakes)
        ...
        if model_mapping.provider == "openrouter":
            ...
            from backoffice.infrastructure.providers.local_sd_provider import (
            ...
            from backoffice.infrastructure.providers.gemini_image_provider import (
                GeminiImageProvider,
            )
