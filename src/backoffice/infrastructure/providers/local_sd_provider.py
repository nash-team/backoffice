...
class LocalStableDiffusionProvider(CoverGenerationPort, ContentPageGenerationPort):
    ...
    def __init__(
        ...
        Args:
            ...
            lora_id: Optional LoRA adapter to load (e.g., artificialguybr/ColoringBookRedmond-V2)
            controlnet_id: Optional ControlNet model to load (e.g., lllyasviel/control_v11p_sd15_lineart)
    ...
    def _load_model(self):
        ...
        try:
            ...
            raise DomainError(
                ...
                actionable_hint="Check disk space (~17GB needed) and internet connection for first download",
    ...
    def _preprocess_for_controlnet(self, spec: ImageSpec) -> Image.Image | None:
        ...
        try:
            ...
            control_image = processor(control_image, low_threshold=50, high_threshold=100)
