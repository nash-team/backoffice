...
class TestApproveEbookUseCase:
    ...
    @pytest.mark.asyncio
    async def test_approve_draft_ebook_success(self, approve_ebook_usecase, ebook_repository, draft_ebook):
    ...
    @pytest.mark.asyncio
    async def test_approve_emits_approved_event(self, approve_ebook_usecase, ebook_repository, draft_ebook, event_bus):
