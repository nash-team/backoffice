...
- Width: 2.0 inches (600px @ 300 DPI)
- Height: 1.5 inches (450px @ 300 DPI)
...
def add_barcode_space(
    ...
    Args:
        ...
        barcode_height_inches: Barcode height in inches (default: 1.5)
    ...
    try:
        ...
        rect_h = inches_to_px(barcode_height_inches)  # 1.5" = 450px
