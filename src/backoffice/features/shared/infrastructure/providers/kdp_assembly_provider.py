...
from backoffice.features.shared.infrastructure.utils.color_utils import ensure_cmyk
from backoffice.features.shared.infrastructure.utils.spine_generator import generate_spine
