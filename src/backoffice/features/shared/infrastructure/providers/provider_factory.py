...
from backoffice.features.shared.domain.policies.model_registry import ModelRegistry
from backoffice.features.shared.domain.ports.assembly_port import AssemblyPort
...
class ProviderFactory:
    ...
    def create_cover_provider(
        ...
        if model_mapping.provider == "openrouter":
            from backoffice.features.shared.infrastructure.providers import (
            ...
            from backoffice.features.shared.infrastructure.providers.local_sd_provider import (
            ...
            from backoffice.features.shared.infrastructure.providers.gemini_image_provider import (
                GeminiImageProvider,
            )
