...
from backoffice.features.shared.infrastructure.utils.spine_generator import (
    get_font_path,
    load_font_safe,
)
...
class OpenRouterImageProvider(CoverGenerationPort, ContentPageGenerationPort):
    ...
    def _get_theme_primary_color(self, theme: str) -> tuple[int, int, int]:
        ...
        from backoffice.features.shared.domain.entities.theme_profile import load_theme_from_yaml
